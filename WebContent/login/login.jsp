...
<section class="login_form">
    ...
    <form name="loginForm" method="post">
        <div class="int-area">
            ...
            <input type="text" id="memId" name="memId" value="${memId }" placeholder="ID" autocomplete="off" required>
        </div>
        <div class="int-area">
            <label for="memPass"></label>
            <input type="password" id="memPass" name="memPass" placeholder="PASSWORD" autocomplete="off" required>
        </div>
        <div class="div_rememberMe">
            <label for="rememberMe">
                <input type="checkbox" id="rememberMe" name="rememberMe" value="Y" ${checkBox }/>ID 저장
            </label>
        </div>
        <div class="btn-area">
            <button type="button" id="btn_id" name="sbtn_id" onclick="fn_login()">LOGIN</button>
            <button type="button" id="btn_join" name="btn_join" onclick="location.href='${pageContext.request.contextPath}/login/join.jsp'">JOIN</button>
        </div>
    </form>
</section>
